...
<div id="spreed" class="section">
    <form id="spreed_settings_form" class="spreed_settings">
        ...
        <p>
            <label for="signaling_server"><?php p($l->t('External signaling servers')) ?></label>
            <textarea type="text" id="signaling_server"
                   name="signaling_server" placeholder="wss://signaling.example.org"><?php p($_['signalingServer']) ?></textarea>
        </p>
        <p>
            <em><?php p($l->t('External signaling servers can optionally be used for larger installations. Use one server per line and leave the field empty to use the internal signaling server.')) ?></em>
        </p>
        <p>
